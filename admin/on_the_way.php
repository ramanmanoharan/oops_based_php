...
<div class="container">
    <div class="card">
        <div class="header ml-5 w-50 bg-dark text-light p-3 rounded shadow" style="margin-top:-30px;">New Booking <a href="on_the_way.php" class="text-light float-right"><i class="fas fa-sync-alt mr-2"></i>Refresh</a></div>
            <table class="table table-borderless mt-4 table-hover">
               ...
               <?php $call = $assign->getData("SELECT * FROM booked WHERE status='0' AND status_2=''");
                if(!$call): ?>
                <tr>
