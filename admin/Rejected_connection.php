...
<div class="container">
    <div class="card">
        <div class="header ml-5 w-50 bg-danger text-light p-3 rounded shadow" style="margin-top:-30px;">Rejected Connection <a href="Rejected_connection.php" class="text-light float-right"><i class="fas fa-sync-alt mr-2"></i>Refresh</a></div>
            <table class="table table-borderless mt-4 table-hover">
               ...
               <?php $call = $connection->getData("SELECT * FROM connection WHERE status='2'");
                if(!$call): ?>
                <tr>
