...
<div class="container">
    <div class="card">
        <div class="header ml-5 w-50 bg-dark text-light p-3 rounded shadow" style="margin-top:-30px;">Confirmed Booking <a href="confirmed_booking.php" class="text-light float-right"><i class="fas fa-sync-alt mr-2"></i>Refresh</a></div>
            <table class="table table-borderless mt-4 table-hover">
               ...
               <?php $data = $booking->getData("SELECT * FROM booked WHERE status='0'");
                if(!$data): ?>
                <tr>
                ...
                <tr>
                    ...
                    <td>
                    <?php if($row['status_1']==""): ?>
                    <span class="badge badge-info badge-pill p-2">Confirmed</span><?php elseif($row['status_2']==""): ?>
