...
<div class="container">
    <div class="card">
        <div class="header ml-5 w-50 bg-info text-light p-3 rounded shadow" style="margin-top:-30px;">New Connection <a href="new_connection.php" class="text-light float-right"><i class="fas fa-sync-alt mr-2"></i>Refresh</a></div>
            <table class="table table-borderless mt-4 table-hover">
               ...
               <?php $call = $connection->getData("SELECT * FROM connection WHERE status=''");
                if(!$call): ?>
                <tr>
